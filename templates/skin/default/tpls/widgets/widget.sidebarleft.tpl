{if E::IsUser()}
    <div class="sidebar-lf">
            ...
            <a href="/profile/{E::IsUser()->getLogin()}" class="hvr-leftline-reveal"><i class="fa fa-user"></i></a>
            ...
            <a href="/profile/{E::IsUser()->getLogin()}/created/topics/" class="hvr-leftline-reveal"><i class="fa fa-file-o"></i></a>
            <a href="/profile/{E::IsUser()->getLogin()}/favourites/topics/" class="hvr-leftline-reveal"><i class="fa fa-star-o"></i></a>
            <a href="/settings/" class="hvr-leftline-reveal"><i class="fa fa-cogs"></i></a>
        ...
        <div class="sidebar-l sidebar-left sidebar-animate">
            <ul class="nav navbar-stacked">
                <li><a href="/profile/{E::IsUser()->getLogin()}">{$aLang.user_menu_profile}</a></li>
                ...
                <li><a href="/profile/{E::IsUser()->getLogin()}/created/topics/">{$aLang.user_menu_publication}</a></li>
                <li><a href="/profile/{E::IsUser()->getLogin()}/favourites/topics/">{$aLang.user_menu_profile_favourites}</a></li>
                <li><a href="/settings/">{$aLang.settings_menu_tuning_short}</a></li>
